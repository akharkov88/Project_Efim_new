...
sync_engine=create_engine(url=settings.database_url_psycopg,
                     ...
                     ) # ensure this is the correct path for the sqlync_engine=create_async_engine(url=settings.database_url_psycopg,
#                      # echo=True,
#                      pool_size=5,# основные соеденения
#                      max_overflow=10,# дополнтиленые соеденения
...
#     async with async_engine.connect() as conn:
#         stm=t"INSERT INTO workers (username) VALUES  ('Boobr'),('Doobr');"
